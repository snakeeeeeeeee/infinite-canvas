...
export type VideoGenerationTask = { id: string; provider: "openai" | "gemini" | "seedance" | "plugin" | "supertoken"; model: string; superTokenTask?: SuperTokenTaskRecord };
...
export async function createVideoGenerationTask(config: AiConfig, prompt: string, references: ReferenceImage[] = [], videoReferences: ReferenceVideo[] = [], audioReferences: ReferenceAudio[] = [], options?: RequestOptions): Promise<VideoGenerationTask> {
    ...
    return createOpenAIVideoTask(requestConfig, selectedModel, prompt, references, mediaOptions);
}
