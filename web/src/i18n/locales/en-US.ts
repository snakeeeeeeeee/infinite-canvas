export default {
    ...
    settingsPanels: {
        ...
        video: { title: "Video settings", quality: "Quality", size: "Size", seconds: "Seconds", resolution: "Resolution", ratio: "Aspect ratio", duration: "Duration", smart: "Smart", output: "Output", generateAudio: "Generate audio", audioRequired: "Generate audio (required by model)", watermark: "Add watermark", adaptive: "Adaptive", referenceMode: "Reference mode", referenceModes: { frame: "Start/end frames", singleImage: "Image to video", images: "Image references", media: "Mixed media" }, frameHint: "Image 1 is the start frame and image 2 is the end frame. Up to {{count}} images.", singleImageHint: "Use one image as the video's starting frame.", imagesHint: "Ordered reference images, up to {{count}}.", mediaHint: "Up to {{images}} images, {{videos}} videos and {{audios}} audio files; {{total}} items total.", mediaVisualHint: "Up to {{images}} images and {{videos}} videos, with {{visualTotal}} visual references total; audio is separate, up to {{audios}}.", noResolution: "No matching resolution SKU is available for this account. Refresh models.", invalidResolution: "This resolution is not available for the current account.", invalidDuration: "This duration is not supported by the model.", invalidRatio: "This aspect ratio is not supported by the model.", invalidReferenceMode: "This reference mode is not supported by the model.", sizes: { landscape: "Landscape", portrait: "Portrait", square: "Square", widescreen: "Widescreen", tall: "Tall", auto: "Auto" }, ratios: { landscape: "Landscape", portrait: "Portrait", square: "Square", standardLandscape: "Standard landscape", standardPortrait: "Standard portrait", cinematic: "Cinematic", adaptive: "Adaptive" } },
        ...
        imageModelPicker: {
            empty: "No models are available in this family",
            customProvider: "Custom provider",
            customModel: "Custom image model",
            resolutionRange: "{{min}}–{{max}}",
            maxResolution: "Up to {{max}}",
            maxOutputs: "Up to {{count}} per request",
            singleOutput: "1 per request",
            generateAndEdit: "Generate and edit",
            recommended: "Recommended",
            families: { "gpt-image": "GPT Image", gemini: "Gemini", grok: "Grok", other: "Other" },
            providers: { azure: "Azure official", adobe: "Adobe", "third-party": "Third-party", google: "Google", xAI: "xAI" },
        ...
        videoModelPicker: {
            ...
            faceUnsupported: "No human faces",
            faceUnknown: "Face support unknown",
            preview: "Preview",
            empty: "No models match the current filters",
            chooseProvider: "Choose {{provider}}",
            customProvider: "Custom provider",
            customSummary: "Custom video model",
            maxSeconds: "Up to {{count}}s",
            startEndFrames: "Start/end frames",
            images: "{{count}} images",
            videos: "{{count}} videos",
            audios: "{{count}} audio",
            families: {
                seedance: { name: "Seedance", caption: "" },
                kling: { name: "Kling", caption: "" },
                minimax: { name: "MiniMax", caption: "" },
                grok: { name: "Grok", caption: "" },
                other: { name: "Other", caption: "" },
            },
            summaries: {
                seedance20: "Standard · up to 15s",
                seedanceFast: "Fast · up to 15s",
                seedance25: "Multimodal · up to 30s",
                kling30: "Start/end frames · native audio",
                klingOmni: "Multi-image references · element consistency",
                minimaxH3: "Full-modal understanding · native stereo",
                grokBase: "Tends to preserve the reference subject and composition",
                grokPreview: "Tends toward stronger reinterpretation and stylization",
            },
        },
    },
    ...
    workbench: {
        ...
        stopPolling: "Stop local polling",
        pollingPaused: "Local polling paused. The server task may still be running; open this record again to resume it.",
    },
    imageWorkbench: {
        title: "Image Studio",
    ...
    videoWorkbench: {
        ...
        noImages: "No reference images. Drag in up to {{count}} files for the current mode.",
        noVideos: "No reference videos. Drag in up to {{count}} files for the current mode.",
        noAudio: "No reference audio. Drag in up to {{count}} MP3/WAV files for the current mode, each under 15 MB.",
        referenceLimitReached: "Some assets exceeded the current model or reference-mode limit and were ignored.",
        ...
        audioDurationInvalid: "Reference audio outside the duration limits was ignored: {{min}}–{{max}} seconds each and {{total}} seconds total.",
        startFrame: "Start frame",
        endFrame: "End frame",
        unsupportedModel: "This model is not available through the SuperToken asynchronous video API",
        clipboardEmpty: "No readable images found on the clipboard",
        clipboardAdded: "Added {{count}} reference images",
        ...
        pollingPaused: "Local polling paused. The server task is preserved; open this record again to resume it.",
    ...
    canvas: {
        ...
        routePicker: { title: "Service route", current: "Current route: {{route}}, {{status}}", cn: "Accelerated route", global: "Global route", cnShort: "Accelerated", globalShort: "Global", default: "Default", healthy: "Available", slow: "Slow", unavailable: "Unavailable", unauthorized: "Invalid credential", timeout: "Timed out", unchecked: "Not checked", checking: "Checking", refresh: "Check routes again", checkedRecently: "Checked recently", autoRefresh: "Checked every 2 minutes", followDefault: "Use default" },
        projectPage: {
            stopAsyncDescription: "This only stops local polling. The asynchronous task may continue on the server; refresh the canvas later to resume it.",
        ...
        generation: { interrupted: "Generation was interrupted by a page refresh. Generate again.", taskMissing: "The asynchronous task record is missing. Generate again.", resumeConfigMissing: "The provider or resource key is missing, so this task cannot be resumed yet.", resultMissing: "The asynchronous task succeeded without a result.", front: "front view", rotateRight: "rotated {{angle}} degrees right", rotateLeft: "rotated {{angle}} degrees left", level: "eye-level view", topDown: "{{angle}}-degree top-down view", lowAngle: "{{angle}}-degree low-angle view", angleLabel: "AI multi-angle: {{horizontal}}, {{pitch}}, camera distance {{distance}}, {{lens}} lens", anglePrompt: "Regenerate a new view of the same subject from the reference image. Preserve the subject, colors, materials, and visual style; do not merely apply perspective distortion. {{angle}}." },
    ...
    config: {
        ...
        superToken: {
            ...
            cn: "Mainland acceleration",
            global: "Global",
            imageKey: "Image Model API Key",
            videoKey: "Video Model API Key",
            resourceKey: "Resource API Key",
            verify: "Verify",
            refreshAll: "Refresh all models",
            lastSynced: "Last synced: {{time}}",
            neverSynced: "Not synced yet",
            syncHint: "Syncs every 5 minutes while visible. Refresh updates authorized models without reconnecting.",
            imageModels: "{{count}} image",
            videoModels: "{{count}} video",
            unsupported: "{{count}} unavailable",
            ...
            availableModelsLoaded: "Refreshed configured models: {{images}} image and {{videos}} video",
            resourceReady: "Resource API Key is available",
            testFailed: "SuperToken verification failed",
            connect: "Connect SuperToken",
            reauthorize: "Reconnect",
            connected: "SuperToken connected",
            notConnected: "Not connected",
            connectedAt: "Authorized at {{time}}",
            advanced: "Advanced settings",
            moduleKeyRequired: "Enter at least one image or video Model API Key",
            authorizationSuccess: "SuperToken connected and saved",
            authorizationFailed: "SuperToken authorization failed",
        },
        modelSelect: {
