export default {
    ...
    canvas: {
        ...
        routePicker: { title: "Service route", current: "Current route: {{route}}, {{status}}", cn: "Accelerated route", global: "Global route", cnShort: "Accelerated", globalShort: "Global", default: "Default", healthy: "Available", slow: "Slow", unavailable: "Unavailable", unauthorized: "Invalid credential", timeout: "Timed out", unchecked: "Not checked", checking: "Checking", refresh: "Check routes again", checkedRecently: "Checked recently", onDemand: "Checked when opened", followDefault: "Use default" },
        projectPage: {
