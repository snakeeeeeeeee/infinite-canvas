export default {
    ...
    canvas: {
        ...
        routePicker: { title: "服务线路", current: "当前线路：{{route}}，{{status}}", cn: "加速节点", global: "国际节点", cnShort: "加速", globalShort: "国际", default: "默认", healthy: "通畅", slow: "较慢", unavailable: "不可用", unauthorized: "凭证不可用", timeout: "检测超时", unchecked: "未检测", checking: "检测中", refresh: "重新检测线路", checkedRecently: "最近检测", onDemand: "展开时检测", followDefault: "跟随默认" },
        projectPage: {
