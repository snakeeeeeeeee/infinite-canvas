export default {
    ...
    settingsPanels: {
        ...
        video: { title: "视频设置", quality: "清晰度", size: "尺寸", seconds: "秒数", resolution: "分辨率", ratio: "比例", duration: "时长", smart: "智能", output: "输出", generateAudio: "生成音轨", audioRequired: "生成音轨（模型固定开启）", watermark: "添加水印", adaptive: "自适应", referenceMode: "参考模式", referenceModes: { frame: "首尾帧", singleImage: "单图生视频", images: "多图参考", media: "混合素材" }, frameHint: "第 1 张图为首帧，第 2 张图为尾帧；最多 {{count}} 张。", singleImageHint: "使用 1 张图片作为视频起始画面。", imagesHint: "普通参考图，可排序，最多 {{count}} 张。", mediaHint: "最多 {{images}} 张图片、{{videos}} 个视频、{{audios}} 个音频，总数 {{total}}。", mediaVisualHint: "最多 {{images}} 张图片、{{videos}} 个视频，图片与视频合计 {{visualTotal}} 个；音频另计，最多 {{audios}} 个。", noResolution: "当前账号没有这个模型可用的分辨率 SKU，请刷新模型。", invalidResolution: "当前分辨率不在账号可用模型中，请重新选择。", invalidDuration: "当前时长不受该模型支持。", invalidRatio: "当前画幅不受该模型支持。", invalidReferenceMode: "当前参考模式不受该模型支持。", sizes: { landscape: "横屏", portrait: "竖屏", square: "方形", widescreen: "宽屏", tall: "长图", auto: "自动" }, ratios: { landscape: "横屏", portrait: "竖屏", square: "方形", standardLandscape: "标准横屏", standardPortrait: "标准竖屏", cinematic: "宽银幕", adaptive: "自适应" } },
        ...
        imageModelPicker: {
            ...
            maxResolution: "最高 {{max}}",
            maxOutputs: "单次最多 {{count}} 张",
            singleOutput: "每次 1 张",
            generateAndEdit: "生成与编辑",
            recommended: "推荐",
            families: { "gpt-image": "GPT Image", gemini: "Gemini", grok: "Grok", other: "其他" },
            providers: { azure: "Azure 官方", adobe: "Adobe", "third-party": "第三方渠道", google: "Google", xAI: "xAI" },
        ...
        videoModelPicker: {
            ...
            human: "真人出镜",
            faceSupported: "支持真人",
            faceUnsupported: "不支持真人",
            faceUnknown: "真人能力未确认",
            preview: "Preview",
            empty: "当前筛选下暂无可用模型",
            chooseProvider: "选择 {{provider}} 渠道",
            customProvider: "自定义渠道",
            customSummary: "自定义视频模型",
            maxSeconds: "最长 {{count}} 秒",
            startEndFrames: "首尾帧",
            images: "{{count}} 图",
            videos: "{{count}} 视频",
            audios: "{{count}} 音频",
            families: {
                seedance: { name: "即梦", caption: "Seedance" },
                kling: { name: "可灵", caption: "Kling" },
                minimax: { name: "MiniMax", caption: "" },
                grok: { name: "Grok", caption: "" },
                other: { name: "其他", caption: "" },
            },
            summaries: {
                seedance20: "标准版 · 最长 15 秒",
                seedanceFast: "快速版 · 最长 15 秒",
                seedance25: "多模态增强 · 最长 30 秒",
                kling30: "首尾帧 · 原生音频",
                klingOmni: "多图参考 · 元素一致性",
                minimaxH3: "全模态理解 · 原生立体声",
                grokBase: "更偏保持参考主体与构图",
                grokPreview: "更偏重新演绎与风格化",
            },
        },
    },
    ...
    workbench: {
        ...
        retrySuccess: "重试成功",
        stopPolling: "停止本地轮询",
        pollingPaused: "本地轮询已暂停，服务端任务仍可能执行；重新打开该记录可继续查询。",
    },
    imageWorkbench: {
        title: "生图工作台",
    ...
    videoWorkbench: {
        ...
        noImages: "暂无参考图，可拖入文件，当前最多 {{count}} 张",
        noVideos: "暂无参考视频，可拖入文件，当前最多 {{count}} 个",
        noAudio: "暂无参考音频，可拖入文件，当前最多 {{count}} 个，mp3/wav，单个 15MB 内",
        referenceLimitReached: "部分素材超过当前模型或参考模式的数量限制，已忽略",
        ...
        audioDurationInvalid: "已忽略不符合时长要求的参考音频：单个 {{min}}-{{max}} 秒，总时长不超过 {{total}} 秒",
        startFrame: "首帧",
        endFrame: "尾帧",
        unsupportedModel: "当前模型尚未接入 SuperToken 异步视频协议",
        clipboardEmpty: "剪切板里没有可读取的图片",
        clipboardAdded: "已读取 {{count}} 张参考图",
        ...
        pollingPaused: "本地轮询已暂停，服务端任务仍保留；重新打开该记录可继续查询。",
        resultTitle: "生成视频",
        source: "视频创作台",
        empty: "还没有生成视频",
    },
    canvas: {
        ...
        routePicker: { title: "服务线路", current: "当前线路：{{route}}，{{status}}", cn: "加速节点", global: "国际节点", cnShort: "加速", globalShort: "国际", default: "默认", healthy: "通畅", slow: "较慢", unavailable: "不可用", unauthorized: "凭证不可用", timeout: "检测超时", unchecked: "未检测", checking: "检测中", refresh: "重新检测线路", checkedRecently: "最近检测", autoRefresh: "每 2 分钟自动检测", followDefault: "跟随默认" },
        projectPage: {
            stopAsyncDescription: "只会停止本地轮询，异步任务仍可能在服务端执行；稍后刷新画布可继续查询。",
        ...
        generation: { interrupted: "页面刷新后生成已中断，请重新生成。", taskMissing: "异步任务记录已丢失，请重新生成。", resumeConfigMissing: "缺少对应渠道或资源 Key，暂时无法继续查询。", resultMissing: "异步任务成功但没有返回结果。", front: "正面视角", rotateRight: "向右旋转 {{angle}} 度", rotateLeft: "向左旋转 {{angle}} 度", level: "水平视角", topDown: "俯视 {{angle}} 度", lowAngle: "仰视 {{angle}} 度", angleLabel: "AI 多角度：{{horizontal}}，{{pitch}}，镜头距离 {{distance}}，{{lens}}镜头", anglePrompt: "基于参考图重新生成同一主体的新视角，保持主体、颜色、材质和画面风格一致，不要只做透视变形。{{angle}}。" },
    ...
    config: {
        ...
        superToken: {
            ...
            cn: "大陆加速",
            global: "国际站点",
            imageKey: "生图 Model API Key",
            videoKey: "视频 Model API Key",
            resourceKey: "Resource API Key",
            verify: "验证",
            refreshAll: "刷新全部模型",
            lastSynced: "最近同步：{{time}}",
            neverSynced: "尚未同步",
            syncHint: "页面可见时每 5 分钟自动同步。刷新模型会同步授权范围，无需重新授权。",
            imageModels: "图片 {{count}}",
            videoModels: "视频 {{count}}",
            unsupported: "暂不可用 {{count}}",
            ...
            availableModelsLoaded: "已刷新已配置的模型：图片 {{images}} 个、视频 {{videos}} 个",
            resourceReady: "Resource API Key 可用",
            testFailed: "SuperToken 验证失败",
            connect: "连接 SuperToken",
            reauthorize: "重新授权",
            connected: "已连接 SuperToken",
            notConnected: "尚未连接",
            connectedAt: "授权于 {{time}}",
            advanced: "高级配置",
            moduleKeyRequired: "生图或视频 Model API Key 至少填写一个",
            authorizationSuccess: "SuperToken 已连接并自动保存",
            authorizationFailed: "SuperToken 授权失败",
        },
        modelSelect: {
